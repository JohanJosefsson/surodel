...
int main()
{
	...
	for (int i = 0; i<1600; i++)
	{
		...
		line.curve += sin(i*3.1415 / 100) + (i > 800)/10.0;
	...
	while (app.isOpen())
	{
		...
		playerX -= lines[pos / segL % N].curve * (speed / 200) / 40;
		...
		for (int n = startPos; n<startPos + 300; n++)
		{
			...
			rumble = Color(abs(sin(n*3.1415 / N)) * 255, abs(sin(rand()))*255, (n/3)%2*255);
